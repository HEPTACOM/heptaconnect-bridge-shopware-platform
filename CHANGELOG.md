...
- Add dependency `Heptacom\HeptaConnect\Portal\Base\Web\Http\Contract\Psr7MessageFormatterContract` and `Heptacom\HeptaConnect\Core\Bridge\File\HttpHandlerDumpPathProviderInterface` to service `Heptacom\HeptaConnect\Core\Web\Http\Contract\HttpHandleServiceInterface`
